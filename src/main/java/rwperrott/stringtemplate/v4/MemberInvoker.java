 ...
 * <ul>
 * <li>Supports all Fields.</li>
 * <li>Only supports Methods with parameter types supported by ArgTypes.</li>
 * <li>Only compares parameters, because should already be group by name, return type should already have been filtered out.</li>
 * </ul>
 *
 * @author rwperrott
 */
interface MemberInvoker extends Comparable<MemberInvoker> {
  ...
  class ForMethod extends Abstract<Method> {
    /**
     * The parameterTypes convertible from String; used for keying and matching.
     */
