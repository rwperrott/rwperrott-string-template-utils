...
public enum STGroupType implements MultilineAppender {
  /**
   * If source contains "::=", new STGroupString(null,source,delimiterStartChar,delimiterStopChar) used.
   */
   ...
   * delimiterStartChar,delimiterStopChar) used.
   */
  ...
  /**
   * If not string or file, new STGroupDir(url,encoding, delimiterStartChar,delimiterStopChar) used.
   */
